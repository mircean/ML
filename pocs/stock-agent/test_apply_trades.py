...
import config
from agent import apply_trades_to_portfolio, TradeRecommendation, Lot
...
class TestApplyTradesToPortfolioBasic(unittest.TestCase):
    ...
    def test_1_no_trades(self):
        ...
        result = apply_trades_to_portfolio(self.initial_portfolio, [])
    ...
    def test_2_buy_new_position(self):
        ...
        result = apply_trades_to_portfolio(self.initial_portfolio, trades)
        ...
        self.assertIn("2025-10", nvda_lot.date)  # Should be today's date
    ...
    def test_3_buy_existing_position(self):
        ...
        self.assertIn("2025-10", new_lot.date)  # Should be today's date
    ...
    def test_6_sell_fifo_multiple_lots_complete_oldest(self):
        ...
        result = apply_trades_to_portfolio(self.multi_lot_portfolio, trades)
