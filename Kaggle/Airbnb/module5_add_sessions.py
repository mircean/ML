...
df_train = pd.read_csv('C:\\Users\mircean\OneDrive\Airbnb\Dataset_sql\\train_users_2_3.csv')
...
df_test = pd.read_csv('C:\\Users\mircean\OneDrive\Airbnb\Dataset_sql\\test_users_3.csv')
...
#column_indexes = [-1] + [i for i in range(300,456)]
for i in column_indexes:
	if i == -1:
		print('compute baseline')
	else:
		column_name = 'SessionsD' + str(i)
		print('processing column', column_name, datetime.now())
		df_all_2 = df_all
		df_all[column_name] = df_all_ini[column_name]
	...
	if(i == -1):
		...
		if score >= best_score + 0.01:
			...
			best_score = score
			features_to_add.append(column_name)
		else:
			#restore df
			df_all = df_all_2
